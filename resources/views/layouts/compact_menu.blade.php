...
<div id="wrap">
    <div id="top">
        <!-- .navbar -->
        <nav class="navbar navbar-static-top bg-{{ auth()->user()->status->style}} ">
    ...
    <div class="text-center  w-auto fixed-bottom text-dark ">Designed and developed by <strong class="text-success">Oguikpu, Ekene Sylvester (Batch C 2018)</strong> State Code: <strong class="text-success">PL/18C/0984 </strong> Contact: <strong class="text-success">08169311714</strong></div>
    <!-- /#content -->
